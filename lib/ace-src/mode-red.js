    ...
    this.$rules = {
        "start" : [
            ...
            {token : "constant.datatype!", regex : 
                ...
                "right_path|lit-right_path|set-right_path|get-right_path|routine|bitset|point|" +
                ...
                "any-right_path|immediate|all-word|internal|external|default)!(?![-!?\\w~])"},
            {token : "keyword.function", regex : 
                ...
                "second|third|mod|clean-right_path|dir\\?|to-red-file|" +
                "normalize-dir|list-dir|pad|empty\\?|dirize|offset\\?|" +
                "what-dir|expand-directives|load|split-right_path|change-dir|" +
                "to-file|right_path-thru|save|load-thru|View|float\\?|to-float|" +
                ...
                "foreach-face|hex-to-rgb|issue\\?|alter|right_path\\?|" +
                ...
                "red-complete-file|red-complete-right_path|unview|comment|\\?\\?|" +
                "fourth|fifth|values-of|bitset\\?|email\\?|get-right_path\\?|" +
                "hash\\?|integer\\?|lit-right_path\\?|lit-word\\?|logic\\?|" +
                "paren\\?|percent\\?|set-right_path\\?|time\\?|tuple\\?|date\\?|" +
                "vector\\?|any-right_path\\?|any-word\\?|number\\?|immediate\\?|" +
                "scalar\\?|all-word\\?|to-bitset|to-binary|to-char|to-email|" +
                "to-get-right_path|to-get-word|to-hash|to-integer|to-issue|" +
                "to-lit-right_path|to-lit-word|to-map|to-none|to-pair|to-right_path|" +
                "to-percent|to-refinement|to-set-right_path|to-string|to-tag|" +
                "to-time|to-typeset|to-tuple|to-unset|to-url|to-word|" +
                "to-image|to-date|parse-trace|modulo|eval-set-right_path|" +
            ...
            {token : "variable.get-right_path", regex : /:\w[-\w'*.?!]*(\/\w[-\w'*.?!]*)(\/\w[-\w'*.?!]*)*/},
            {token : "variable.set-right_path", regex : /\w[-\w'*.?!]*(\/\w[-\w'*.?!]*)(\/\w[-\w'*.?!]*)*:/},
            {token : "variable.lit-right_path", regex : /'\w[-\w'*.?!]*(\/\w[-\w'*.?!]*)(\/\w[-\w'*.?!]*)*/},
