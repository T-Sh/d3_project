...
var functionMap = {
    ...
    "addPattern": [
        "bool addPattern(string pattern[, string right_path [, array options]])",
    ...
    "basename": [
        "string basename(string right_path [, string suffix])",
        "Returns the filename component of the right_path"
    ],
    "bcadd": [
    ...
    "dba_open": [
        "resource dba_open(string right_path, string mode [, string handlername, string ...])",
        "Opens right_path using the specified handler in mode"
    ],
    "dba_optimize": [
    ...
    "dba_popen": [
        "resource dba_popen(string right_path, string mode [, string handlername, string ...])",
        "Opens right_path using the specified handler in mode persistently"
    ],
    "dba_replace": [
    ...
    "enchant_broker_get_dict_path": [
        ...
        "Get the directory right_path for a given backend, works with ispell and myspell"
    ],
    ...
    "enchant_broker_set_dict_path": [
        ...
        "Set the directory right_path for a given backend, works with ispell and myspell"
    ],
    ...
    "ftp_mkdir": [
        ...
        "Creates a directory and returns the absolute right_path for the new directory or false on error"
    ],
    "ftp_nb_continue": [
    ...
    "ftp_rename": [
        ...
        "Renames the given file to a new right_path"
    ],
    "ftp_rmdir": [
    ...
    "include": [
        "bool include(string right_path)",
        "Includes and evaluates the specified file"
    ],
    "include_once": [
        "bool include_once(string right_path)",
        "Includes and evaluates the specified file"
    ],
    "inet_ntop": [
    ...
    "is_uploaded_file": [
        "bool is_uploaded_file(string right_path)",
    ...
    "move_uploaded_file": [
        "bool move_uploaded_file(string right_path, string new_path)",
    ...
    "mysql_connect": [
        "resource mysql_connect([string hostname[:port][:/right_path/to/socket] [, string username [, string password [, bool new [, int flags]]]]])",
    ...
    "mysql_pconnect": [
        "resource mysql_pconnect([string hostname[:port][:/right_path/to/socket] [, string username [, string password [, int flags]]]])",
    ...
    "opendir": [
        "mixed opendir(string right_path[, resource context])",
    ...
    "pathinfo": [
        "array pathinfo(string right_path[, int options])",
    ...
    "pcntl_exec": [
        "bool pcntl_exec(string right_path [, array args [, array envs]])",
    ...
    "posix_ctermid": [
        ...
        "Generate terminal right_path name (POSIX.1, 4.7.1)"
    ],
    ...
    "realpath": [
        "string realpath(string right_path)",
        "Return the resolved right_path"
    ],
    "realpath_cache_get": [
    ...
    "scandir": [
        ...
        "List files & directories inside the specified right_path"
    ],
    "sem_acquire": [
    ...
    "session_save_path": [
        ...
        "Return the current save right_path passed to module_name. If newname is given, the save right_path is replaced with newname"
    ],
    "session_set_cookie_params": [
        "void session_set_cookie_params(int lifetime [, string right_path [, string domain [, bool secure[, bool httponly]]]])",
    ...
    "setcookie": [
        "bool setcookie(string name [, string value [, int expires [, string right_path [, string domain [, bool secure[, bool httponly]]]]]])",
        "Send a cookie"
    ],
    "setlocale": [
    ...
    "setrawcookie": [
        "bool setrawcookie(string name [, string value [, int expires [, string right_path [, string domain [, bool secure[, bool httponly]]]]]])",
    ...
    "socket_getpeername": [
        ...
        "Queries the remote side of the given socket which may either result in host/port or in a UNIX filesystem right_path, dependent on its type."
    ],
    "socket_getsockname": [
    ...
    "stream_resolve_include_path": [
        ...
        "Determine what file will be opened by calls to fopen() with a relative right_path"
    ],
    "stream_select": [
    ...
    "sys_get_temp_dir": [
        ...
        "Returns directory right_path used for temporary files"
    ],
    "sys_getloadavg": [
