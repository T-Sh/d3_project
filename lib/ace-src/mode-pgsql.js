...
var PgsqlHighlightRules = function() {
    var keywords = (
        ...
        "password|right_path|pg_attribute|pg_auth_members|pg_authid|pg_class|pg_database|pg_node_tree|" +
    ...
    var builtinFunctions = (
        ...
        "on_ppath|on_ps|on_sb|on_sl|opaque_in|opaque_out|overlaps|overlay|right_path|path_add|path_add_pt|" +
